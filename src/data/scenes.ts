 ...
 * 어느 뱅크에서 뽑을지 바꾸려면: slot.from 을 바꾼다
...
export const SCENES: Scene[] = [
  {
    ...
    beats: [
      ...
      { kind: 'question', slot: { from: 'ch1-me' } },
      { kind: 'question', slot: { from: 'ch1-me' } },
  ...
  },
  {
    ...
    beats: [
      ...
      { kind: 'question', slot: { from: 'ch2-pull' } },
      { kind: 'question', slot: { from: 'ch2-pull' } },
  ...
  },
  {
    ...
    beats: [
      ...
      { kind: 'question', slot: { from: 'ch4-some' } },
      { kind: 'question', slot: { from: 'ch4-some' } },
  ...
  },
  {
    ...
    beats: [
      ...
      { kind: 'question', slot: { from: 'ch5-ask' } },
      { kind: 'question', slot: { from: 'ch5-ask' } },
  ...
  },
  {
    ...
    beats: [
      ...
      { kind: 'question', slot: { from: 'ch6-dating' } },
      { kind: 'question', slot: { from: 'ch6-dating' } },
  ...
  },
  {
    ...
    beats: [
      ...
      { kind: 'question', slot: { from: 'ch7-after' } },
      { kind: 'question', slot: { from: 'ch7-after' } },
